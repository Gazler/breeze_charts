defmodule Breeze.Charts.LineChartTest do
  ...
  test "line and bar charts accept the same keyed category data and optional colors" do
    ...
    for content <- [line, bar] do
      ...
      assert Enum.any?(content, &(&1.style == %{foreground_color: :primary}))
      assert Enum.any?(content, &(&1.style == %{foreground_color: :secondary}))
    end
